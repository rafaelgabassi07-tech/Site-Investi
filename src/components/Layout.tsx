          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-2 md:gap-4 ml-auto">
              ...
              <div className="hidden lg:block relative">
                <form onSubmit={handleSearch} className="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-xl focus-within:border-blue-500/50 focus-within:ring-1 focus-within:ring-blue-500/50 transition-all duration-300">
                      ...
                      <div className="max-h-[240px] overflow-y-auto no-scrollbar">
                        {suggestions.map((s) => (
                          <Link 
                            ...
                            className="flex items-center justify-between px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-b border-slate-100 dark:border-slate-800/50 last:border-none"
                          >
                            <div>
                              <div className="font-bold text-slate-900 dark:text-white text-xs">{s.ticker}</div>
                              <div className="text-[10px] text-slate-500 truncate max-w-[120px]">{s.name}</div>
                            </div>
                            <div className="text-[9px] font-black text-slate-600 uppercase bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">{s.type}</div>
                          </Link>
                        ))}
                      </div>
                    </motion.div>
              ...
              <button 
                ...
                className="lg:hidden p-2.5 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5 rounded-xl border border-transparent dark:border-white/10 transition-all"
              >
              ...
              <button 
                onClick={toggleTheme}
                className="p-2 sm:p-2.5 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5 rounded-xl border border-transparent hover:border-slate-200 dark:hover:border-white/10 transition-all flex items-center justify-center"
                title="Alternar Tema"
              >
