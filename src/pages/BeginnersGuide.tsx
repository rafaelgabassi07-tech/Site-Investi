    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <h2 className="text-display-md text-white">Primeiros Passos</h2>
            ...
            {steps.map((step, idx) => (
              ...
              >
                <div className={`w-14 h-14 rounded-2xl bg-${step.color}-500/10 flex items-center justify-center text-${step.color}-500 border border-${step.color}-500/20 shrink-0`}>
                  <step.icon className="icon-lg" />
                </div>
                <div className="space-y-2">
                  <h3 className="text-display-tiny text-white group-hover:text-blue-400 transition-colors uppercase">{step.title}</h3>
        ...
        <div className="space-y-6">
          <h2 className="text-display-md text-white">Conteúdo Recomendado</h2>
          <div className="card p-8 bg-gradient-to-br from-blue-600 to-blue-800 border-none relative overflow-hidden group">
            ...
            <PlayCircle className="text-white/20 absolute -bottom-4 -right-4 rotate-12 group-hover:scale-110 transition-transform w-24 h-24" />
            
            <div className="relative z-10 space-y-6">
              <div className="inline-block px-3 py-1 bg-white/20 rounded-lg text-white text-label">
                Masterclass Gratuita
              </div>
              <h3 className="text-display-md text-white leading-tight">Como montar sua primeira carteira de ações</h3>
          ...
          <div className="card p-6 md:p-8 space-y-6">
            <h3 className="text-display-sm text-white">Checklist do Investidor</h3>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
                  <div className="w-6 h-6 rounded-full border-2 border-slate-700 flex items-center justify-center">
                    <CheckCircle2 className="icon-xs text-slate-700" />
                  </div>
